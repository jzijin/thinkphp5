<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\amp\apache\htdocs\tp5\public/../application/admin\view\index\artadd.html";i:1521615587;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div id="rside">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <p>
                        <select name="cat_id">
                            ...
                            <option value="<?php echo $catlist['cat_id']; ?>"><?php echo $catlist['catname']; ?></option>
                ...
                <div class="form-group">
                    ...
                    <p>
                        <script id="editor" type="text/plain" style="width:600px;height:400px;" name="content"></script>
